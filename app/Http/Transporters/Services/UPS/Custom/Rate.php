...
class Rate extends Ups
{
	...
	private function createRequest(RateRequest $rateRequest)
	{
		...
		$request->appendChild($xml->createElement('SubVersion', '1801'));
		...
		$numOfPieces = $shipment->getNumOfPiecesInShipment();
		if (isset($numOfPieces)){
			$shipmentNode->appendChild($xml->createElement('NumOfPieces', $numOfPieces));
		}
