...
use DOMDocument;
use DOMElement;
use Ups\Entity\AccessPointCOD;
use Ups\Entity\CallTagARS;
use Ups\Entity\DeliveryConfirmation;
use Ups\Entity\InternationalForms;
use Ups\Entity\LabelDelivery;
...
class ShipmentServiceOptions extends \Ups\Entity\ShipmentServiceOptions implements NodeInterface
{
	/**
	 * @var
	 */
	...
	public function __construct($response = null)
	{
		...
		if (null !== $response) {
			...
			if (isset($response->ReturnService)) {
				$this->setReturnService($response->ReturnService);
			}
	...
	public function toNode(DOMDocument $document = null)
	{
		...
		if (isset($this->returnService)) {
			$node->appendChild($this->returnService->toNode($document));
		}
